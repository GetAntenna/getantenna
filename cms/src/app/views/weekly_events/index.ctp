<div id="contentWrapper" class="SF_left">
	...
	<section id="content" class="SF_niceclear">
		...
		<div id="contentList" class="fadeArea noIcons">
			<table class="dataTable dataWeeklyTable">
				<thead>
					<tr>
						<th>Day</th>
						<th>Date&nbsp;&amp;&nbsp;Time</th>
			...
			<?php 
				...
				{
					$itemTitle = "<b>". $item['WeeklyEvent']['title'] ."</b>&nbsp;&nbsp;&nbsp;&nbsp;". $item['WeeklyEvent']['address'];
			...
			?>
					<tr>
						<td><?php echo date("l", strtotime($item['WeeklyEvent']['start'])); ?></td>
						<td><?php echo date("d-m-y", strtotime($item['WeeklyEvent']['start'])); ?> <?php echo substr($item['WeeklyEvent']['stime'], 0, -3); ?></td>
						<td>
							<a href="<?php echo Router::url(array('action' => 'edit', $item['WeeklyEvent']['id'])); ?>"><?php echo $itemTitle; ?></a>
						</td>
						<td><?php echo ucwords(str_replace("_", " ", $item['WeeklyEvent']['category'])); ?></td>
						<td><?php echo $item['WeeklyEvent']['id']; ?></td>
					</tr>
			<?php
				}
			?>
...
<?php echo $this->element('aside_recurring'); ?>