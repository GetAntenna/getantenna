<div id="contentWrapper" class="SF_left">
	<div id="contentHeader" class="SF_niceclear">
		<div id="contentHeaderMargin" class="SF_niceclear">
			<h1>Add recurring event <span>(<a class="admin" href="<?php echo Router::url(array('action' => 'index')); ?>"><?php __('Cancel', false); ?></a>)</span></h1>
			<div id="sectionToolbar">
				<button type="submit" class="readyButton" id="readyButtonTop" form="WeeklyEventAddForm"><span><?php __('Add recurring event', false); ?></span></button>
			</div>
		</div>
	</div>
		...
		<?php echo $this->Form->create(null, array('url' => array('action' => 'add'), 'enctype' => 'multipart/form-data')); ?>
			...
			<div class="actions SF_niceclear">
				<div class="actionsPrimary">
					<button type="submit" class="readyButton" id="readyButton"><span><?php __('Add recurring event', false); ?></span></button>
				</div>
